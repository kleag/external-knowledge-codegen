...
import datasets.codagen.bleu_score as bleu_score
...
""" Parses a file in the natural .jsonl format that the Codagen corpus comes in.
...
""" This builds the reference list for BLEU scoring
    @param reference_file_name: The reference file can be downloaded from https://codagen-corpus.github.io/ as
                                codagen_annotations.v1.0.zip/examples.annotated.test.json
